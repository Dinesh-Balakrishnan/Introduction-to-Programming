public class Practice7 {
  ...
  /*                              PROBLEM:
  Create a method called mickeyBox that creates an image with the following specifications:
...
    }
  ...
  /*                              PROBLEM:
  Create a method called showDesign that creates an image with the following specifications:
...
    }
  ...
  /*                              PROBLEM:
  Create a method called squares that creates an image with the following specifications:
...
    }
  ...
  /*                              PROBLEM:
  Create a method called triangle that creates an image with the following specifications:
